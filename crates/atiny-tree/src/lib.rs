...
//! not have dependency with anything of the compiler only with atiny-locationt that provides
//! constructions to localize things in the source code.
//!
//! The trees available in this module are:
//!
//! - Abstract: It is a purely syntatic tree that does not have semantic information, it comes from
//!   the parser.
